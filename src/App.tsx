  ...
  const featureCards: FeatureCard[] = [
    {
      ...
      to: '/login',
      color: 'bg-gradient-to-br from-rose-600 to-red-400',
      isProtected: false,
      hideWhenAuth: true
    },
    {
      ...
      to: '/signup',
      color: 'bg-gradient-to-br from-violet-600 to-fuchsia-400',
      isProtected: false,
      hideWhenAuth: true
    },
    {
    ...
    },
    {
      ...
      to: '#',
      color: 'bg-gradient-to-br from-amber-600 to-yellow-300',
      isProtected: false,
      onClick: () => {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 py-8 md:py-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 w-full max-w-6xl mx-auto px-2 sm:px-4">
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className={`flex flex-col items-center justify-center p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl ${card.color} text-white font-bold text-sm sm:text-lg lg:text-xl cursor-pointer select-none home-feature-card w-full aspect-square`}
                  style={{
        ...
        <motion.button
          ...
          className="flex flex-col items-center justify-center p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl bg-gradient-to-br from-pink-600 to-purple-400 text-white font-bold text-sm sm:text-lg lg:text-xl select-none home-feature-card focus:outline-none cursor-pointer w-full aspect-square"
          style={{
            boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
            backdropFilter: 'blur(8px)',
            border: '1.5px solid rgba(255,255,255,0.18)',
